...
# first input MUST BE: /Users/joshuagrajales/Desktop/astrre
# second input must be: /Users/joshuagrajales/Downloads/MIST_v1.2_vvcrit0.4_UBVRIplus.txz
...
def plt_iso():
    ...
    #datai = ascii.read(cwd + untar_iso_path[-30:]+"/MIST_v1.2_feh_"+index+"_afe_p0.0_vvcrit0.4_full.iso")
